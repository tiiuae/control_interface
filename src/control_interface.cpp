...
/* angle conversions //{ */
double radToDeg(const double &angle_rad) { return angle_rad * 180.0 / M_PI; }

double degToRad(const double &angle_deg) { return angle_deg * M_PI / 180.0; }
//}
...
globalToLocal(const std::shared_ptr<mavsdk::geometry::CoordinateTransformation>
                  &coord_transform,
...
/* localToGlobal //{ */
std::pair<double, double>
localToGlobal(const std::shared_ptr<mavsdk::geometry::CoordinateTransformation>
                  &coord_transform,
...
private:
  ...
  rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr
      desired_pose_publisher_; // https://ctu-mrs.github.io/docs/system/relative_commands.html
  rclcpp::Publisher<geometry_msgs::msg::PoseArray>::SharedPtr
      waypoint_marker_publisher_;
  rclcpp::Publisher<geometry_msgs::msg::PoseArray>::SharedPtr
      waypoint_there_and_back_publisher_;

  rclcpp::Publisher<fog_msgs::msg::ControlInterfaceDiagnostics>::SharedPtr
  ...
  rclcpp::Subscription<px4_msgs::msg::MissionResult>::SharedPtr
  ...
  void
  controlModeCallback(const px4_msgs::msg::VehicleControlMode::UniquePtr msg);
  void
  landDetectedCallback(const px4_msgs::msg::VehicleLandDetected::UniquePtr msg);
  ...
  rclcpp::Service<fog_msgs::srv::WaypointToLocal>::SharedPtr
  ...
  rclcpp::Service<fog_msgs::srv::SetPx4ParamFloat>::SharedPtr
  ...
  rclcpp::Client<fog_msgs::srv::SetPx4ParamFloat>::SharedPtr
      set_px4_param_float_client_;

  // service callbacks
  bool
  armingCallback(const std::shared_ptr<std_srvs::srv::SetBool::Request> request,
                 std::shared_ptr<std_srvs::srv::SetBool::Response> response);
  bool takeoffCallback(
      const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
      std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  bool
  landCallback(const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
               std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  bool localWaypointCallback(
      const std::shared_ptr<fog_msgs::srv::Vec4::Request> request,
      std::shared_ptr<fog_msgs::srv::Vec4::Response> response);
  bool
  localPathCallback(const std::shared_ptr<fog_msgs::srv::Path::Request> request,
                    std::shared_ptr<fog_msgs::srv::Path::Response> response);
  bool gpsWaypointCallback(
      const std::shared_ptr<fog_msgs::srv::Vec4::Request> request,
      std::shared_ptr<fog_msgs::srv::Vec4::Response> response);
  bool
  gpsPathCallback(const std::shared_ptr<fog_msgs::srv::Path::Request> request,
                  std::shared_ptr<fog_msgs::srv::Path::Response> response);
  bool waypointToLocalCallback(
      const std::shared_ptr<fog_msgs::srv::WaypointToLocal::Request> request,
      std::shared_ptr<fog_msgs::srv::WaypointToLocal::Response> response);
  bool pathToLocalCallback(
      const std::shared_ptr<fog_msgs::srv::PathToLocal::Request> request,
      std::shared_ptr<fog_msgs::srv::PathToLocal::Response> response);

  bool setPx4ParamIntCallback(
      const std::shared_ptr<fog_msgs::srv::SetPx4ParamInt::Request> request,
      std::shared_ptr<fog_msgs::srv::SetPx4ParamInt::Response> response);
  bool setPx4ParamFloatCallback(
      const std::shared_ptr<fog_msgs::srv::SetPx4ParamFloat::Request> request,
      std::shared_ptr<fog_msgs::srv::SetPx4ParamFloat::Response> response);
  bool getPx4ParamIntCallback(
      const std::shared_ptr<fog_msgs::srv::GetPx4ParamInt::Request> request,
      std::shared_ptr<fog_msgs::srv::GetPx4ParamInt::Response> response);
  bool gpsOriginCallback(
      rclcpp::Client<fog_msgs::srv::GetOrigin>::SharedFuture future);
  bool odomAvailableCallback(
      rclcpp::Client<fog_msgs::srv::GetBool>::SharedFuture future);
...
/* constructor //{ */
ControlInterface::ControlInterface(rclcpp::NodeOptions options)
    : Node("control_interface", options) {
  ...
  try {
    ...
    RCLCPP_ERROR(this->get_logger(),
                 "[%s]: Environment variable DRONE_DEVICE_ID was not defined!",
                 this->get_name());
  }
  RCLCPP_INFO(this->get_logger(), "[%s]: UAV name is: '%s'", this->get_name(),
              uav_name_.c_str());
  ...
  if (control_update_rate_ < 5.0) {
    ...
    RCLCPP_WARN(this->get_logger(),
                "[%s]: Control update rate set too slow. Defaulting to 5 Hz",
                this->get_name());
  }
  ...
  try {
    ...
    RCLCPP_ERROR(this->get_logger(),
                 ...
                 this->get_name(), device_url_.c_str());
    exit(EXIT_FAILURE);
  }
  if (connection_result != mavsdk::ConnectionResult::Success) {
    RCLCPP_ERROR(this->get_logger(), "[%s]: Connection failed: %s",
                 this->get_name(), connection_result);
    exit(EXIT_FAILURE);
  } else {
    RCLCPP_INFO(this->get_logger(), "[%s]: MAVSDK connected to device: %s",
                this->get_name(), device_url_.c_str());
  }

  bool connected = false;
  while (rclcpp::ok() && !connected) {
    RCLCPP_INFO(this->get_logger(), "[%s]: Systems size: %ld", this->get_name(),
                mavsdk_.systems().size());
    if (mavsdk_.systems().size() < 1) {
      RCLCPP_INFO(this->get_logger(), "[%s]: Waiting for connection at URL: %s",
                  this->get_name(), device_url_.c_str());
      rclcpp::sleep_for(std::chrono::seconds(1));
    }
    for (unsigned i = 0; i < mavsdk_.systems().size(); i++) {
      if (mavsdk_.systems().at(i)->get_system_id() == 1) {
        RCLCPP_INFO(this->get_logger(), "[%s]: ID: %u", this->get_name(),
  ...
  telemetry_->subscribe_home(
      std::bind(&ControlInterface::homeCallback, this, _1));
  //}
  ...
  vehicle_command_publisher_ =
      this->create_publisher<px4_msgs::msg::VehicleCommand>(
          "~/vehicle_command_out", qos);
  desired_pose_publisher_ =
      this->create_publisher<geometry_msgs::msg::PoseStamped>(
          "~/desired_pose_out", qos);
  waypoint_marker_publisher_ =
      this->create_publisher<geometry_msgs::msg::PoseArray>(
          "~/waypoint_markers_out", qos);
  diagnostics_publisher_ =
      this->create_publisher<fog_msgs::msg::ControlInterfaceDiagnostics>(
          "~/diagnostics_out", qos);

  // subscribers
  control_mode_subscriber_ =
      this->create_subscription<px4_msgs::msg::VehicleControlMode>(
          "~/control_mode_in", rclcpp::SystemDefaultsQoS(),
          std::bind(&ControlInterface::controlModeCallback, this, _1), sub_opt);
  land_detected_subscriber_ =
      this->create_subscription<px4_msgs::msg::VehicleLandDetected>(
          "~/land_detected_in", rclcpp::SystemDefaultsQoS(),
          std::bind(&ControlInterface::landDetectedCallback, this, _1),
          sub_opt);
  mission_result_subscriber_ =
      this->create_subscription<px4_msgs::msg::MissionResult>(
          "~/mission_result_in", rclcpp::SystemDefaultsQoS(),
          std::bind(&ControlInterface::missionResultCallback, this, _1),
          sub_opt);
  odometry_subscriber_ = this->create_subscription<nav_msgs::msg::Odometry>(
      "~/local_odom_in", rclcpp::SystemDefaultsQoS(),
      std::bind(&ControlInterface::odometryCallback, this, _1), sub_opt);

  callback_handle_ = this->add_on_set_parameters_callback(
      std::bind(&ControlInterface::parametersCallback, this, _1));

  // service clients
  get_origin_client_ =
      this->create_client<fog_msgs::srv::GetOrigin>("~/get_origin");
  getting_odom_client_ =
      this->create_client<fog_msgs::srv::GetBool>("~/getting_odom");
  octomap_reset_client_ =
      this->create_client<std_srvs::srv::Empty>("~/octomap_reset_out");
  ...
  takeoff_service_ = this->create_service<std_srvs::srv::Trigger>(
      "~/takeoff_in",
      std::bind(&ControlInterface::takeoffCallback, this, _1, _2),
      qos.get_rmw_qos_profile(), callback_group_);
  land_service_ = this->create_service<std_srvs::srv::Trigger>(
      "~/land_in", std::bind(&ControlInterface::landCallback, this, _1, _2),
      qos.get_rmw_qos_profile(), callback_group_);
  local_waypoint_service_ = this->create_service<fog_msgs::srv::Vec4>(
      "~/local_waypoint_in",
      std::bind(&ControlInterface::localWaypointCallback, this, _1, _2),
      qos.get_rmw_qos_profile(), callback_group_);
  local_path_service_ = this->create_service<fog_msgs::srv::Path>(
      "~/local_path_in",
      std::bind(&ControlInterface::localPathCallback, this, _1, _2),
      qos.get_rmw_qos_profile(), callback_group_);
  gps_waypoint_service_ = this->create_service<fog_msgs::srv::Vec4>(
      "~/gps_waypoint_in",
      std::bind(&ControlInterface::gpsWaypointCallback, this, _1, _2),
      qos.get_rmw_qos_profile(), callback_group_);
  gps_path_service_ = this->create_service<fog_msgs::srv::Path>(
      "~/gps_path_in",
      std::bind(&ControlInterface::gpsPathCallback, this, _1, _2),
      qos.get_rmw_qos_profile(), callback_group_);
  waypoint_to_local_service_ =
      this->create_service<fog_msgs::srv::WaypointToLocal>(
          "~/waypoint_to_local_in",
          std::bind(&ControlInterface::waypointToLocalCallback, this, _1, _2),
          qos.get_rmw_qos_profile(), callback_group_);
  path_to_local_service_ = this->create_service<fog_msgs::srv::PathToLocal>(
      "~/path_to_local_in",
      std::bind(&ControlInterface::pathToLocalCallback, this, _1, _2),
      qos.get_rmw_qos_profile(), callback_group_);
  set_px4_param_int_ = this->create_service<fog_msgs::srv::SetPx4ParamInt>(
      "~/set_px4_param_int",
      std::bind(&ControlInterface::setPx4ParamIntCallback, this, _1, _2));
  get_px4_param_int_ = this->create_service<fog_msgs::srv::GetPx4ParamInt>(
      "~/get_px4_param_int",
      std::bind(&ControlInterface::getPx4ParamIntCallback, this, _1, _2));
  set_px4_param_float_ = this->create_service<fog_msgs::srv::SetPx4ParamFloat>(
      "~/set_px4_param_float",
      std::bind(&ControlInterface::setPx4ParamFloatCallback, this, _1, _2));

  set_px4_param_float_client_ =
      this->create_client<fog_msgs::srv::SetPx4ParamFloat>(
          "~/set_px4_param_float");

  control_timer_ = this->create_wall_timer(
      std::chrono::duration<double>(1.0 / control_update_rate_),
      std::bind(&ControlInterface::controlRoutine, this), callback_group_);
  ...
  RCLCPP_INFO(this->get_logger(), "[%s]: Setting %s, value: %f",
              this->get_name(), request->param_name.c_str(), request->value);
...
/* parametersCallback //{ */
rcl_interfaces::msg::SetParametersResult ControlInterface::parametersCallback(
    ...
    if (param.get_name() == "takeoff_height") {
      if (param.get_type() == rclcpp::ParameterType::PARAMETER_DOUBLE) {
        if (param.as_double() >= 0.5 && param.as_double() < 10) {
          ...
          RCLCPP_INFO(this->get_logger(), "[%s]: Parameter: '%s' set to %1.2f",
                      this->get_name(), param.get_name().c_str(),
                      param.as_double());
        } else {
        ...
        snprintf(buff, sizeof(buff), "parameter '%s' has to be type DOUBLE",
      ...
      if (param.get_type() == rclcpp::ParameterType::PARAMETER_DOUBLE) {
        if (param.as_double() > 0.0) {
          ...
          snprintf(buff, sizeof(buff),
                   "parameter '%s' cannot be set to %1.2f because it is not >0",
                   param.get_name().c_str(), param.as_double());
          result.reason = buff;
        }
      } else {
      ...
      if (param.get_type() == rclcpp::ParameterType::PARAMETER_BOOL) {
        ...
        result.successful = true;
        RCLCPP_INFO(this->get_logger(), "[%s]: Parameter: '%s' set to %s",
                    this->get_name(), param.get_name().c_str(),
                    param.as_bool() ? "TRUE" : "FALSE");
      } else {
        snprintf(buff, sizeof(buff), "parameter '%s' has to be type BOOL",
                 param.get_name().c_str());
        result.reason = buff;
      }
      //}
      ...
      snprintf(buff, sizeof(buff),
               "parameter '%s' cannot be changed dynamically",
               param.get_name().c_str());
      result.reason = buff;
    }
  }
  ...
  if (!result.successful) {
    RCLCPP_WARN(this->get_logger(), "[%s]: Failed to set parameter: %s",
                this->get_name(), result.reason.c_str());
  }
...
/* controlModeCallback //{ */
void ControlInterface::controlModeCallback(
  ...
  if (!previous_manual_flag && current_manual_flag) {
    RCLCPP_INFO(this->get_logger(),
                "[%s]: Control flag switched to manual. Stop commanding",
                this->get_name());
    stop_commanding_.store(true);
    if (!stopPreviousMission()) {
      RCLCPP_ERROR(
          this->get_logger(),
          "[%s]: Previous mission cannot be stopped. Manual landing required",
          this->get_name());
    }
  }
  ...
  if (armed_.load() != msg->flag_armed) {
    ...
    if (armed_.load()) {
      ...
      RCLCPP_WARN(this->get_logger(), "[%s]: Vehicle disarmed",
                  this->get_name());
      if (landed_.load() && stop_commanding_.load()) {
        RCLCPP_INFO(this->get_logger(), "[%s]: Auto control will be enabled",
                    this->get_name());
...
void ControlInterface::landDetectedCallback(
...
void ControlInterface::missionResultCallback(
    const px4_msgs::msg::MissionResult::UniquePtr msg) {
  if (!is_initialized_.load()) {
    return;
  }
...
/* odometryCallback //{ */
void ControlInterface::odometryCallback(
  ...
  std::tuple<float, float, float> pos =
      std::make_tuple(msg->pose.pose.position.x, msg->pose.pose.position.y,
...
/* takeoffCallback //{ */
bool ControlInterface::takeoffCallback(
  ...
  if (!is_initialized_.load()) {
    ...
    RCLCPP_ERROR(this->get_logger(), "[%s]: %s", this->get_name(),
...
/* landCallback //{ */
bool ControlInterface::landCallback(
    [[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request>
        request,
    std::shared_ptr<std_srvs::srv::Trigger::Response> response) {
...
/* armingCallback //{ */
bool ControlInterface::armingCallback(
    [[maybe_unused]] const std::shared_ptr<std_srvs::srv::SetBool::Request>
        request,
    std::shared_ptr<std_srvs::srv::SetBool::Response> response) {
  ...
  if (request->data) {
    ...
    if (result != mavsdk::Action::Result::Success) {
      ...
      response->success = true;
      armed_.store(true);
      RCLCPP_WARN(this->get_logger(), "[%s]: %s", this->get_name(),
                  response->message.c_str());
      return true;
    }
  } else {
...
bool ControlInterface::localWaypointCallback(
    const std::shared_ptr<fog_msgs::srv::Vec4::Request> request,
    std::shared_ptr<fog_msgs::srv::Vec4::Response> response) {
  ...
  response->success = true;
  RCLCPP_INFO(this->get_logger(), "[%s]: %s", this->get_name(),
              response->message.c_str());
...
/* localPathCallback //{ */
bool ControlInterface::localPathCallback(
...

  {
    ...
    RCLCPP_INFO(this->get_logger(), "[%s]: Got %d waypoints", this->get_name(),
                request->path.poses.size());
...
/* gpsWaypointCallback //{ */
bool ControlInterface::gpsWaypointCallback(
    const std::shared_ptr<fog_msgs::srv::Vec4::Request> request,
    std::shared_ptr<fog_msgs::srv::Vec4::Response> response) {
...
/* gpsPathCallback //{ */
bool ControlInterface::gpsPathCallback(
    const std::shared_ptr<fog_msgs::srv::Path::Request> request,
    std::shared_ptr<fog_msgs::srv::Path::Response> response) {
...
bool ControlInterface::waypointToLocalCallback(
    const std::shared_ptr<fog_msgs::srv::WaypointToLocal::Request> request,
    std::shared_ptr<fog_msgs::srv::WaypointToLocal::Response> response) {
  ...
  std::stringstream ss;
  ss << "Transformed GPS [" << request->latitude_deg << ", "
     << request->longitude_deg << ", " << request->relative_altitude_m
     << "] into local: [" << response->local_x << ", " << response->local_y
     << ", " << response->local_z << "]";
...
bool ControlInterface::pathToLocalCallback(
    const std::shared_ptr<fog_msgs::srv::PathToLocal::Request> request,
    std::shared_ptr<fog_msgs::srv::PathToLocal::Response> response) {
  ...
  for (auto &pose : request->path.poses) {
    ...
    std::stringstream ss;
    ss << "Transformed GPS [" << global.latitude << ", " << global.longitude
       << "] into local: [" << p_out.x << ", " << p_out.y << "]";
    response->message = ss.str();
    response->success = true;
    RCLCPP_INFO(this->get_logger(), "[%s]: %s", this->get_name(),
                response->message.c_str());
  ...
  std::stringstream ss;
  ss << "Transformed " << request->path.poses.size() << " GPS poses into "
     << response->path.poses.size() << " local poses";
...
bool ControlInterface::setPx4ParamIntCallback(
    [[maybe_unused]] const std::shared_ptr<
        fog_msgs::srv::SetPx4ParamInt::Request>
        request,
    std::shared_ptr<fog_msgs::srv::SetPx4ParamInt::Response> response) {
  ...
  if (result == mavsdk::Param::Result::Success) {
    ...
    RCLCPP_INFO(this->get_logger(),
                ...
                request->param_name.c_str(), request->value);
    ...
    response->success = false;
    RCLCPP_ERROR(this->get_logger(),
                 "[ControlInterface]: PX4 parameter set uknown error");
    ...
    response->success = false;
    RCLCPP_ERROR(this->get_logger(),
                 "[ControlInterface]: PX4 parameter set request time out");
    ...
    RCLCPP_ERROR(
        this->get_logger(),
        "[ControlInterface]: PX4 parameter set request connection error");
    ...
    response->success = false;
    RCLCPP_ERROR(this->get_logger(),
                 "[ControlInterface]: PX4 parameter set request wrong type");
    ...
    RCLCPP_ERROR(
        this->get_logger(),
        "[ControlInterface]: PX4 parameter set request param name too long");
  }
...
bool ControlInterface::getPx4ParamIntCallback(
    [[maybe_unused]] const std::shared_ptr<
        fog_msgs::srv::GetPx4ParamInt::Request>
        request,
    std::shared_ptr<fog_msgs::srv::GetPx4ParamInt::Response> response) {
  ...
  if (result.first == mavsdk::Param::Result::Success) {
    ...
    RCLCPP_ERROR(
        this->get_logger(),
        "[ControlInterface]: PX4 parameter get request connection error");
  } else if (result.first == mavsdk::Param::Result::WrongType) {
    response->message = "Did not get the parameter - request wrong type";
    response->param_name = request->param_name;
    response->success = false;
    RCLCPP_ERROR(this->get_logger(),
                 "[ControlInterface]: PX4 parameter get request wrong type");
    ...
    RCLCPP_ERROR(
        this->get_logger(),
        "[ControlInterface]: PX4 parameter get request param name too long");
  }
...
bool ControlInterface::setPx4ParamFloatCallback(
    [[maybe_unused]] const std::shared_ptr<
        fog_msgs::srv::SetPx4ParamFloat::Request>
        request,
    std::shared_ptr<fog_msgs::srv::SetPx4ParamFloat::Response> response) {
  ...
  if (result == mavsdk::Param::Result::Success) {
    ...
    response->success = true;
    RCLCPP_INFO(this->get_logger(),
                "[ControlInterface]: PX4 parameter %s successfully set to %f",
                request->param_name.c_str(), request->value);
  } else if (result == mavsdk::Param::Result::Unknown) {
    response->message = "Parameter did not set - unknown error";
    response->param_name = request->param_name;
...
/* gpsOriginCallback //{ */
bool ControlInterface::gpsOriginCallback(
    rclcpp::Client<fog_msgs::srv::GetOrigin>::SharedFuture future) {
  ...
  if (result->success) {
    ...
    coord_transform_ =
        std::make_shared<mavsdk::geometry::CoordinateTransformation>(
            mavsdk::geometry::CoordinateTransformation(ref));

    RCLCPP_INFO(this->get_logger(),
                "[%s]: GPS origin set! Lat: %.3f, Lon: %.3f", this->get_name(),
    ...
    RCLCPP_WARN_THROTTLE(this->get_logger(), clk, 1000,
                         "[%s]: Waiting for GPS origin.", this->get_name());
...
bool ControlInterface::odomAvailableCallback(
    rclcpp::Client<fog_msgs::srv::GetBool>::SharedFuture future) {
  std::shared_ptr<fog_msgs::srv::GetBool::Response> result = future.get();
  if (result->value) {
    RCLCPP_INFO(this->get_logger(), "[%s]: Odometry available!",
                this->get_name());
    getting_odom_.store(true);
  } else {
    auto &clk = *this->get_clock();
    RCLCPP_WARN_THROTTLE(this->get_logger(), clk, 1000,
                         "[%s]: Waiting for Odometry", this->get_name());
...
/* homeCallback //{ */
void ControlInterface::homeCallback(
    const mavsdk::Telemetry::Position home_position) {
  RCLCPP_INFO_ONCE(this->get_logger(),
                   "[%s]: Getting home position from telemetry!",
                   this->get_name());
...
void ControlInterface::controlRoutine(void) {
  ...
  if (is_initialized_.load()) {
    ...
    if (gps_origin_set_.load() && getting_odom_.load()) {
      ...
      RCLCPP_INFO_ONCE(this->get_logger(), "[%s]: CONTROL INTERFACE IS READY",
                       this->get_name());

      if (!armed_.load()) {
        RCLCPP_INFO_THROTTLE(this->get_logger(), *this->get_clock(), 1000,
                             "[%s]: Vehicle not armed", this->get_name());
        return;
      }

      if (landed_.load()) {
        RCLCPP_INFO_THROTTLE(this->get_logger(), *this->get_clock(), 1000,
                             "[%s]: Vehicle not airborne", this->get_name());
        return;
      }
      ...
      if (stop_commanding_.load()) {
        RCLCPP_WARN_THROTTLE(
            ...
            "[%s]: Control action prevented by an external trigger",
            this->get_name());
        return;
      }
      ...
      if (motion_started_.load()) {

        {
          ...
          if (waypoint_buffer_.size() > 0 && mission_finished_.load()) {
            publishDebugMarkers();
            RCLCPP_INFO(this->get_logger(),
                        "[%s]: Waypoints to be visited: %ld", this->get_name(),
                        waypoint_buffer_.size());
            mission_->pause_mission();
            mission_plan_.mission_items.clear();

            addToMission(waypoint_buffer_.front());
            desired_pose_ = Eigen::Vector4d(
                waypoint_buffer_.front().x, waypoint_buffer_.front().y,
                waypoint_buffer_.front().z, waypoint_buffer_.front().yaw);
        ...
        if (mission_finished_.load()) {
          RCLCPP_INFO(this->get_logger(),
                      "[%s]: All waypoints have been visited",
                      this->get_name());
          motion_started_.store(false);
        }
      }
      ...
      if (!gps_origin_set_.load()) {
        RCLCPP_INFO_THROTTLE(this->get_logger(), *this->get_clock(), 1000,
                             "[%s]: GPS origin not set", this->get_name());
      }
      ...
      if (!getting_odom_.load() && !getting_odom_called_.load()) {
        ...
        auto call_result = getting_odom_client_->async_send_request(
            request, std::bind(&ControlInterface::odomAvailableCallback, this,
                               std::placeholders::_1));
        RCLCPP_INFO_THROTTLE(this->get_logger(), *this->get_clock(), 1000,
...
void ControlInterface::printSensorsStatus() {
  ...
  RCLCPP_INFO_THROTTLE(this->get_logger(), *this->get_clock(), 1000,
                       "[%s]: GPS origin set:%s", this->get_name(),
                       gps_origin_set_.load() ? "TRUE" : "FALSE");
}
//}
...
bool ControlInterface::takeoff() {
  ...
  if (result != mavsdk::Action::Result::Success) {
    RCLCPP_ERROR(this->get_logger(), "[%s]: Failed to set takeoff height %.2f",
                 this->get_name(), takeoff_height_);
    return false;
  }
  ...
  if (reset_octomap_before_takeoff_) {
    ...
    RCLCPP_INFO(this->get_logger(), "[%s]: Resetting octomap server",
                this->get_name());
  }
...

  {
    ...
    if (pos_samples_.size() < takeoff_position_samples_) {
      RCLCPP_WARN(
          this->get_logger(),
          "[%s]: Takeoff rejected. Need %ld odometry samples, only have %ld",
          this->get_name(), takeoff_position_samples_, pos_samples_.size());
      return false;
    }
  }
...
bool ControlInterface::land() {
  ...
  RCLCPP_INFO(this->get_logger(), "[%s]: Landing called. Stop commanding",
              this->get_name());
  stop_commanding_.store(true);
...
bool ControlInterface::startMission() {
  ...
  if (stop_commanding_.load()) {
    RCLCPP_WARN(this->get_logger(),
                "[%s]: Mission start prevented by external trigger",
                this->get_name());
    return false;
  }
  ...
  if (result != mavsdk::Mission::Result::Success) {
    RCLCPP_ERROR(this->get_logger(), "[%s]: Mission start rejected",
                 this->get_name());
    return false;
  }
...
bool ControlInterface::uploadMission() {
  ...
  if (stop_commanding_.load()) {
    RCLCPP_WARN(this->get_logger(),
                "[%s]: Mission upload prevented by external trigger",
                this->get_name());
    return false;
  }
  ...
  if (result != mavsdk::Mission::Result::Success) {
    RCLCPP_ERROR(this->get_logger(), "[%s]: Mission upload failed",
                 this->get_name());
    return false;
  }
...
bool ControlInterface::stopPreviousMission() {
...

  {
    ...
    if (result != mavsdk::Mission::Result::Success ||
        mission_plan_.mission_items.size() > 0) {
      RCLCPP_ERROR(this->get_logger(),
                   "[%s]: Previous mission cannot be stopped",
                   this->get_name());
      return false;
    }
  }
  RCLCPP_INFO(this->get_logger(), "[%s]: Previous mission stopped",
              this->get_name());
  return true;
}
//}
...
void ControlInterface::addToMission(local_waypoint_t w) {
  ...
  RCLCPP_INFO(this->get_logger(),
              "[%s]: Added waypoint LOCAL: [%.2f, %.2f, %.2f, %.2f]",
              this->get_name(), w.x, w.y, w.z, w.yaw);
  RCLCPP_INFO(this->get_logger(), "[%s]: GLOBAL: [%.2f, %.2f, %.2f, %.2f]",
              this->get_name(), item.latitude_deg, item.longitude_deg,
...

  {
    ...
    for (auto &w : waypoint_buffer_) {
      ...
      Eigen::Quaterniond q = Eigen::AngleAxisd(0, Eigen::Vector3d::UnitX()) *
                             Eigen::AngleAxisd(0, Eigen::Vector3d::UnitY()) *
                             Eigen::AngleAxisd(w.yaw, Eigen::Vector3d::UnitZ());
      p.orientation.w = q.w();
      p.orientation.x = q.x();
      p.orientation.y = q.y();
      p.orientation.z = q.z();
...
/* generateColor//{ */
std_msgs::msg::ColorRGBA ControlInterface::generateColor(const double r,
                                                         const double g,
                                                         const double b,
                                                         const double a) {
...
/* parse_param //{ */
template <class T>
bool ControlInterface::parse_param(const std::string &param_name,
                                   T &param_dest) {
